        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="page-header-title">
                    <h5 class="m-b-10">TIPO DE CLIENTES</h5>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-body">
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                        ...
                        <div class="input-icon mb-3">
                            ...
                            <input type="hidden" value="tipo_clientes" id="modulo">
                                ...
                                <ul>
                                    <li>
                                        <label class="form-check">
                                            <input class="form-check-input" name="filter" type="checkbox" onclick="filterGeneral('tipo_clientes', 0)">
                                            <span class="form-check-label">Todos</span>
                                        </label>
                                    </li>
                                    <li>
                                        <label class="form-check">
                                            <input class="form-check-input" name="filter" type="checkbox" onclick="filterGeneral('tipo_clientes', 1)">
                                            <span class="form-check-label">Eliminados</span>
                                        </label>
                                    </li>
                                    <li>
                                        <label class="form-check">
                                            <input class="form-check-input" name="filter" type="checkbox" checked onclick="filterGeneral('tipo_clientes', 2)">
                    ...
                    <div class="col-6 col-sm-2 col-md-2 offset-md-1">
                        ...
                        <button onclick="openModal('modal-tipo_cliente','tipo_clientes', 0)" class="btn btn-primary">
                ...
                <div class="btn-group table-actions">
                    ...
                    <a href="{{ route('downloadPlantillaTipoCliente') }}" target="_blank" class="btn btn-dark btn-icon" aria-label="Button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Descargar plantilla" download="Excel tipó de clientes">
                        <i class="ti ti-file-download icono"></i>
                    </a>
                    <button class="btn btn-dark btn-icon" aria-label="Button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Recargar" onclick="getTipoClientes(2, '');">
...
<div class="modal modal-blur fade" id="modal-tipo_cliente" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-title"></h5>
                <button type="button" class="btn-close" onclick="closeModal('modal-tipo_cliente', 'form-add-tipo_cliente')"></button>
            </div>
            <div class="modal-body">
                <form id="form-add-tipo_cliente">
                    <div class="tab-content">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" class="form-control" name="tipo_cliente" id="tipo_cliente" placeholder="Tipo de cliente" required autocomplete="off" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚüÜ]{2,25}+[a-zA-ZñÑáéíóúÁÉÍÓÚüÜ]{2,25}+[a-zA-ZñÑáéíóúÁÉÍÓÚüÜ]{2,50}">
                                <div class="invalid-feedback" id="error-tipo_cliente"></div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-red btn-pill" onclick="closeModal('modal-tipo_cliente', 'form-add-tipo_cliente')">Cancelar</button>
...
<div class="modal modal-blur fade" id="upload-tipo-cliente" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Subir excel de tipo de clientes</h5>
                <button type="button" class="btn-close" onclick="closeModal('upload-´tipo-cliente', 'form-upload-tipo-cliente')"></button>
            </div>
            <div class="modal-body">
                <form id="form-upload-tipo-cliente">
                    <div class="tab-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-red btn-pill" onclick="closeModal('upload-tipo-cliente', 'form-upload-tipo-cliente')">Cancelar</button>
                            <button type="submit" class="btn btn-blue btn-pill">
...
<div class="modal modal-blur fade" id="modal-detalle-tipo_cliente" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-sm modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Detalles</h5>
                <button type="button" class="btn-close" onclick="closeModal('modal-detalle-tipo_cliente', 'form-add-tipo_cliente')"></button>
            </div>
            <div class="modal-body">
                <label class="form-label">Tipo de cliente:</label>
                <p id="nom-tipo_cliente"></p>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-red btn-pill" onclick="closeModal('modal-detalle-tipo_cliente', 'form-add-tipo_cliente')">Cerrar</button>
            </div>
        </div>
    </div>
</div>
