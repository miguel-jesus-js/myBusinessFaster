        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4">
                <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
                    ...
                    <li class="breadcrumb-item active"><i class="ti ti-clipboard-list me-2"></i><a href="/inventario">Inventario</a></li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6">
                        ...
                        <div class="input-icon mb-3">
                            ...
                            <input type="hidden" value="inventario" id="modulo">
                                ...
                                <ul>
                                    {{-- <li>
                                        <label class="form-check">
                                            <input class="form-check-input" name="filter" type="checkbox" onclick="filterGeneral('inventario', 0)">
                                            <span class="form-check-label">Todos</span>
                                        </label>
                                    </li>
                                    <li>
                                        <label class="form-check">
                                            <input class="form-check-input" name="filter" type="checkbox" onclick="filterGeneral('inventario', 1)">
                                            <span class="form-check-label">Eliminados</span>
                                        </label>
                                    </li> --}}
                                    <li>
                                        <label class="form-check">
                                            <input class="form-check-input" name="filter" type="checkbox" disabled checked onclick="filterGeneral('inventario', 2)">
                ...
                <div class="btn-group table-actions">
                    ...
                    <div class="dropdown-menu" data-bs-popper="static">
                        ...
                        <button class="dropdown-item">
                            <ul>
                                <li>
                                    <a href="/api/exportarPdfIventario/2" class="dropdown-item" onclick="">PDF</a>
                                </li>
                                <li>
                                    <a href="/api/exportarExcelIventario/2" class="dropdown-item" onclick="">Excel</a>
                                </li>
                            </ul>
                        </button>
                    </div>
                    <button class="btn btn-dark btn-icon" aria-label="Button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Recargar" onclick="getinventario(2, 2, '');;">
                        <i class="ti ti-refresh icono"></i>
                    </button>
                </div>
                <br><br>
                <div class="table-responsive">
                    <table id="table-inventario" class="table shadow-sm bg-white table-bordered">
