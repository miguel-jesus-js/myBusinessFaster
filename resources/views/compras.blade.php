        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4">
                <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
                    ...
                    <li class="breadcrumb-item active"><i class="ti ti-brand-shopee me-2"></i><a href="/compras">Compras</a></li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="page-body">
                <div class="row">
                    ...
                    <div class="col-6 col-sm-2 col-md-2 offset-md-1">
                        ...
                        <button onclick="openModal('modal-compra','compras', 0)" class="btn btn-primary">
                            Agregar compra
                        </button>
                    </div>
                </div><!-- row end -->
                ...
                <div class="btn-group table-actions">
                    ...
                    <button class="btn btn-dark btn-icon" aria-label="Button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Recargar" onclick="getHistorial(2, 0, 5, '', 1);">
...
<div class="modal modal-blur fade" id="modal-compra" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modal-title"></h5>
                <button type="button" class="btn-close" onclick="closeModal('modal-compra', 'form-add-compra')"></button>
            </div>
                    ...
                    <form action="" id="form-add-venta">
                        <section class="costos">
                            <div class="row mb-2 d-flex justify-content-end">
                                ...
                                <div class="col-auto">
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" name="tipo" id="tipo" required autocomplete="off" readonly value="1">
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-2 d-flex justify-content-end">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-red btn-lg  w-50" onclick="closeModal('modal-compra', 'form-add-compra')">Cancelar</button>
                            </div>
                        </section>
                    </form>
                </div>
