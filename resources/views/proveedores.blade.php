        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4">
                <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><a href="/proveedores">Proveedores</a></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-body">
                ...
                <div class="btn-group table-actions">
                    <a href="{{ route('exportarPdfProveedor') }}" class="btn btn-dark btn-icon" aria-label="Button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Exportar PDF">
                        ...
                        <div class="tab-pane active show" id="tab-datos-pers">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="empresa" id="empresa" placeholder="Empresa" autocomplete="off" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚüÜ]{2,25}+[a-zA-ZñÑáéíóúÁÉÍÓÚüÜ]{2,25}+[a-zA-ZñÑáéíóúÁÉÍÓÚüÜ]{2,50}" value="SoftCode">
