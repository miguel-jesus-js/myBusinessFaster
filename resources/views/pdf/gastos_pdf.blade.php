    ...
    <div class="container py-5">
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $i+1 }}</td>
                    <td>{{ $gastos[$i]['user']['nombres'].' '.$gastos[$i]['user']['apm'].' '. $gastos[$i]['user']['apm'] }}</td>
                    <td>{{ $gastos[$i]['tipoGasto']['tipo'] }}</td>
                    <td>{{ Carbon\Carbon::parse($gastos[$i]['fecha'])->format('d/m/Y h:i:s A') }}</td>
