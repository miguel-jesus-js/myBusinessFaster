        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <div class="page-header-title">
                    <h5 class="m-b-10">CUENTAS POR COBRAR</h5>
            ...
            <div class="col-md-4">
                <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
                    ...
                    <li class="breadcrumb-item"><i class="ti ti-calendar-event me-2"></i><a href="/realizar_pago">Cuentas por cobrar</a></li>
                </ol>
            </div>
        </div>
    </div>
                      ...
                      <div id="collapse-1" class="accordion-collapse collapse" data-bs-parent="#accordion-example" style="">
                        <div class="accordion-body pt-0">
                            <form id="form-filter" action="">
                                <div class="row">
                                    <input type="hidden" value="cuentas_por_cobrar" id="modulo">
