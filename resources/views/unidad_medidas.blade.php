        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4">
                <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
                    <li class="breadcrumb-item"><i class="ti-brand-airtable me-2"></i><a href="#">Unidad de medidas</a></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-body">
                                ...
                                <ul>
                                    <li>
                                        <label class="form-check">
                                            <input class="form-check-input" name="filter" type="checkbox" onclick="filterGeneral('unidad_medidas', 'api/getUnidadMedidas/', 0)">
                                            <span class="form-check-label">Todos</span>
                                        </label>
                                    </li>
                                    <li>
                                        <label class="form-check">
                                            <input class="form-check-input" name="filter" type="checkbox" onclick="filterGeneral('unidad_medidas', 'api/getUnidadMedidas/', 1)">
                                            <span class="form-check-label">Eliminados</span>
                                        </label>
                                    </li>
                                    <li>
                                        <label class="form-check">
                                            <input class="form-check-input" name="filter" type="checkbox" checked onclick="filterGeneral('unidad_medidas', 'api/getUnidadMedidas/', 2)">
                ...
                <div class="d-flex justify-content-end">
                    <button class="btn" aria-label="Button" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Recargar" onclick="getUnidadMedidas('api/getUnidadMedidas/', 2);">
...
@endsection
@section('script')
<script src="{{ asset('assets/js/unidad_medida/config.js') }}"></script>
