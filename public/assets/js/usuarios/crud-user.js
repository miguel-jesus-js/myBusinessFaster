            ...
            $.each(data, function(index, valor){
                ...
                row += `
                    <tr class="${elimnado}">
                        ...
                        <td>
                            <button type="button" class="btn p-0 border-0" onclick="confirmDelete(${valor.id}, '${valor.nombres}', 'api/deleteUsuarios/', 'usuario');"><i class="ti ti-trash icono text-danger"></i></button>
                        </td>
