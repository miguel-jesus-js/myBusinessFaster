...
class ProductosRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'cod_sat'           => 'nullable|min:1|max:99999999|unique:productos,cod_sat,'.$this->id,
            ...
            'color'             => 'nullable|min:3|max:50|regex:/^[a-zA-Z]+(\s*[a-zA-Z]*)*[a-zA-Z]+$/',
            'talla'             => 'nullable|min:2|max:15|regex:/^[a-zA-Z]+(\s*[a-zA-Z]*)*[a-zA-Z]+$/',
            'modelo'            => 'nullable|min:3|max:50|regex:/^[a-zA-Z]+(\s*[a-zA-Z]*)*[a-zA-Z]+$/',
            'meses_garantia'    => 'nullable|min:0|max:36|numeric',
            'peso_kg'           => 'nullable|min:0|max:500|numeric',
            'desc_detallada'    => 'nullable|min:5|max:200|regex:/^[a-zA-Z0-9,.!? ]*$/',
    ...
    public function messages()
    {
        return [
            ...
            'talla.min'                 => 'La talla debe de tener mínimo 3 caracteres',
