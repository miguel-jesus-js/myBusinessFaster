...
class ProductosRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'marca_id'          => 'required|numeric|exists:marcas,id',
            'almacene_id'       => 'required|numeric|exists:almacenes,id',
            'unidad_medida_id'  => 'required|numeric|exists:unidad_medidas,id',
            'proveedore_id'     => 'required|numeric|exists:proveedores,id',
            'materiale_id'      => 'nullable|numeric|exists:materiales,id',
            'cod_barra'         => 'required|min:8|max:13|regex:/^[0-9a-zA-Z]+$/|unique:productos,cod_barra,'.$this->id,
    ...
    public function messages()
    {
        return [
            ...
            'marca_id.exists'           => 'La marca no coincide con las marcas de la base de datos',
            'almacene_id.required'      => 'Seleccione un almacén',
            'almacene_id.numeric'       => 'El almacén debe ser un número',
            'almacene_id.exists'        => 'El almacén no coincide con los almacenes de la base de datos',
            'unidad_medida_id.required' => 'Seleccione una unidad de medida',
            'unidad_medida_id.numeric'  => 'La unidad de medida debe ser un número',
            'unidad_medida_id.exists'   => 'La unidad de medida no coincide con las unidad de medidas de la base de datos',
            'proveedore_id.required'    => 'Seleccione un proveedor',
            'proveedore_id.numeric'     => 'El proveedor debe ser un número',
            'proveedore_id.exists'      => 'El proveedor no coincide con los proveedores de la base de datos',
            'materiale_id.numeric'      => 'El material debe ser un número',
            'materiale_id.exists'       => 'El material no coincide con los materiales de la base de datos',
            'cod_barra.required'        => 'Escribe algún código de barra',
            'cod_barra.min'             => 'El código de barra debe de tener mínimo 8 dígitos',
